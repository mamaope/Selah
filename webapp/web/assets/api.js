...
(function (global) {
  ...
  global.SelahAPI = {
    ...
    editShopItem: (b, lid, id, body)    => call('PATCH','/entries/' + b + '/shopping/' + lid + '/items/' + id, body),
    shopUndo:     (b, lid, id)          => call('POST', '/entries/' + b + '/shopping/' + lid + '/items/' + id + '/undo'),
    delList:      (b, lid)              => call('DELETE','/entries/' + b + '/shopping/' + lid),
    renameList:   (b, lid, name)        => call('PATCH','/entries/' + b + '/shopping/' + lid, { name }),
    ...
    addBudgetItem: (b, it)              => call('POST', '/entries/' + b + '/budget-items', it),
    delBudgetItem: (b, id)              => call('DELETE', '/entries/' + b + '/budget-items/' + id),
    budgetItemToShop: (b, id)           => call('POST', '/entries/' + b + '/budget-items/' + id + '/to-shopping'),
